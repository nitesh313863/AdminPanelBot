...
BOT_TOKEN = '7971326394:AAG7ZTwgIhp1g10Z5UqziyEK0Kl7sXc0iVs'  # Use your bot token here
...
# from telethon.sync import TelegramClient
# from telethon.tl.types import User, Chat, Channel  # ✅ Import types
# from telethon.tl.functions.channels import GetParticipants  # ✅ For fetching participants
# from telethon.tl.types import ChannelParticipantsAdmins  # ✅ To filter admins
# import sys
# import json
# import asyncio
# import random
...
# # Group Chat ID passed from Java or CLI
# if len(sys.argv) > 1:
#     group_chat_id = int(sys.argv[1])  # Get group ID from command line
# else:
#     print(json.dumps({"error": "❌ No group ID provided"}))
...
#         # ✅ Fetch all admins to check admin status
#         # admin_participants = await client(GetParticipants(group, ChannelParticipantsAdmins()))
#         # admin_ids = [admin.participant.user_id for admin in admin_participants.participants]
...
#         print(json.dumps(members))  # Send JSON to Java
#     except Exception as e:
#         print(json.dumps({"error": str(e)}))
...
#             # ✅ Add member details with all required fields
#             members.append({
#                 "user_id": participant.id,
#                 "first_name": participant.first_name,
#                 "last_name": participant.last_name,
#                 "username": participant.username,
                ...
                # "lang_code": participant.lang_code if hasattr(participant, 'lang_code') else None,
                # "profile_photo": await client.download_profile_photo(participant, file=bytes) if participant.photo else None,
                # "is_admin": participant.admin_rights is not None
#             })
